        ...
        >
          {projects.map((project, idx) => (
            <motion.div
              ...
              className={`group flex flex-col bg-slate-50 dark:bg-slate-900 rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-2xl transition-all duration-500 ${
                project.featured ? "lg:col-span-1" : "lg:col-span-2 lg:flex-row"
              }`}
            >
              {/* Image Container */}
              <div
              ...
              {/* Content */}
              <div
                className={`p-8 md:p-10 flex flex-col justify-center ${project.featured ? "flex-1" : "lg:w-3/5"}`}
              >
